<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="opciones_admin.aspx.cs" Inherits="appAmascuotas.opciones_admin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <style>
	...
	<asp:ObjectDataSource ID="odsOpciones" runat="server" SelectMethod="PR_SEG_GET_OPCIONES" TypeName="appAmascuotas.Clases.Opciones">
		<SelectParameters>
        ...
        <asp:View ID="View1" runat="server">
			<!-- begin form-group row -->
										<div class="form-group row m-b-10">
											...
											<div class="col-md-6">
                                                <asp:Button ID="btnNuevo" class="btn btn-success btn-sm" OnClick="btnNuevo_Click" runat="server" Text="New Option" />
										...
										<!-- begin page-header -->
											<h1 class="page-header">Option Admin <small></small></h1>
											...
											<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="ddlMenuPadre" InitialValue="SELECT"  Font-Bold="True"></asp:RequiredFieldValidator>	
										<!-- end page-header -->
											<!-- begin panel -->
												...
												<table id="tabla1" class="table table-striped table-bordered">
													...
													<tbody>
														...
														<ItemTemplate>
															...
															<td>
																<asp:Button ID="btnEditar" class="btn btn-success btn-sm"  CommandArgument='<%# Eval("OPCION") %>' OnClick="btnEditar_Click" runat="server" Text="Edit" ToolTip="Edit" />
																<asp:Button ID="btnEliminar" class="btn btn-success btn-sm" CommandArgument='<%# Eval("OPCION")+ "|"+Eval("DESC_ESTADO") %>' OnClick="btnEliminar_Click"  runat="server" Text="Activate/Desactivate" ToolTip="Activate or desactivate register" />
		 ...
		 <asp:View ID="View2" runat="server">
			...
			<div class="row">
				...
				<div class="col-md-6 offset-md-2">
					...
					<legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16 text-inverse">Data Options</legend>
				...
				<!-- begin form-group row -->
					...
					<!-- begin form-group row -->
					<div class="form-group row m-b-10">
						<label class="col-md-3 text-md-right col-form-label">Detail:</label>
						<div class="col-md-6">
