...
namespace appAmascuotas.Clases
{
    public class Interventions
    {
        ...
        public Interventions(long pB_ID_CLIENT)
        {
            _PB_ID_CLIENT = pB_ID_CLIENT;
            RecuperarDatos();
        }
        public Interventions(string pV_TIPO_OPERACION, long pB_ID_CLIENT, string pV_TYPE_CLIENT, string pV_SOCIETY, string pV_NAME, string pV_SURNAMES, DateTime pD_DATE_BIRTH,
        ...
        public static DataTable PR_CLI_GET_INTERVENTIOS_CLIENT(string PV_ID_CLIENT)
        {
            try
            {
                DbCommand cmd = db1.GetStoredProcCommand("PR_CLI_GET_INTERVENTIOS_CLIENT");
                if(PV_ID_CLIENT==""||PV_ID_CLIENT=="SELECT")
                    db1.AddInParameter(cmd, "PV_ID_CLIENT", DbType.Int64, null);
                else
                    db1.AddInParameter(cmd, "PV_ID_CLIENT", DbType.Int64,Int64.Parse(PV_ID_CLIENT));
