<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="reporteBoletaJuridica.aspx.cs" Inherits="appAmascuotas.reporteBoletaJuridica" %>
...
<!-- begin #content -->
	<div id="content" class="content">
		<div class="row">
			<h1 class="page-header">AmasCuotas <small>Boleta de Pago</small></h1>
			<br />
