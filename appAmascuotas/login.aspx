<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="appAmascuotas.login" %>
...
<body class="pace-top bg-white">
	...
	<div id="page-container" class="fade">
		...
		<div class="login login-with-news-feed">
			<!-- begin news-feed -->
			<div class="news-feed">
				<div class="news-image" style="background-image: url(Imagenes/fondo1.jpg)"></div>
			...
			<div class="right-content">
				...
				<div class="login-content">
						<div class="form-group m-b-15">
                            <asp:TextBox ID="txtUsuario" class="form-control form-control-lg" placeholder="User Name" required runat="server"></asp:TextBox>
						...
						<div class="login-buttons">
                            <asp:Button ID="btnIngresar" OnClick="btnIngresar_Click" class="btn btn-success btn-block btn-lg" runat="server" Text="Login" />
					...
					<div class="login-buttons">
                            <asp:Button ID="btnReset" OnClick="btnReset_Click" class="btn btn-default btn-block btn-lg" runat="server" Text="Reset password" />
							<%--<button type="submit" class="btn btn-success btn-block btn-lg">Sign me in</button>--%>
						</div>
						...
						<p class="text-center text-grey-darker">
							&copy; MLinfo All Right Reserved 2023
						</p>
