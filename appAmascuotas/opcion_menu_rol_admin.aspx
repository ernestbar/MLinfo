<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="opcion_menu_rol_admin.aspx.cs" Inherits="appAmascuotas.opcion_menu_rol_admin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<asp:ObjectDataSource ID="odsOpcionRolNoAsignado" runat="server" SelectMethod="PR_SEG_GET_OPCIONES_A_ASIGNAR" TypeName="appAmascuotas.Clases.Opciones_Menu_rol">
		<SelectParameters>
            <asp:ControlParameter ControlID="ddlMenuRol" Name="PD_MEN_COD_MENU" Type="String" />
			<asp:ControlParameter ControlID="ddlRol" Name="PB_ROL_ID_ROL" Type="String" />
	...
	<!-- begin #content -->
		<div id="content" class="content">
			...
			<!-- begin form-group row -->
										...
										<!-- begin page-header -->
											<h1 class="page-header">Assigning options to roles menus<small></small></h1>
											Role:
										...
										<%--<div class="table-responsive">--%>
												<table id="data-table-default" class="table table-striped table-bordered">
													<thead>
														<tr>
															<th class="text-wrap">OPTION ROL MENU ASIGN </th>
															<th class="text-nowrap">OPTION ROL MENU UN ASSIGN</th>
														</tr>
													</thead>
													<tbody>
														<tr>
																	 ...
																	 <asp:Repeater ID="Repeater1" DataSourceID="odsOpcionRolAsignado" OnItemDataBound="Repeater1_ItemDataBound"  runat="server">
																		<ItemTemplate>
																			<tr class="gradeA">
																				...
																				<td>
																					<asp:Button ID="btnQuitar" class="btn btn-success btn-sm"  CommandArgument='<%# Eval("ROL_OPCION")+ "|"  + Eval("OPCION") %>' OnClick="btnQuitar_Click" runat="server" Text="Delete" ToolTip="Delete menu assign" />
																				</td>
																			</tr>
																		</ItemTemplate>
																	</asp:Repeater>
																	 ...
																	 <asp:Repeater ID="Repeater2" DataSourceID="odsOpcionRolNoAsignado" OnItemDataBound="Repeater2_ItemDataBound" runat="server">
																		<ItemTemplate>
																			<tr class="gradeA">
																				<td><asp:Label ID="lblRazonSocial" runat="server" Text='<%# Eval("DESCRIPCION") %>'></asp:Label></td>
																				<td>
																					<asp:Button ID="btnAgregar" class="btn btn-success btn-sm"  CommandArgument='<%# Eval("OPCION") %>' OnClick="btnAgregar_Click" runat="server" Text="Add" ToolTip="Assign menu" />
																				</td>
																			</tr>
																		</ItemTemplate>
																	</asp:Repeater>
