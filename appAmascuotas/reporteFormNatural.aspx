<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="reporteFormNatural.aspx.cs" Inherits="appAmascuotas.reporteFormNatural" %>
...
<!-- begin #content -->
	<div id="content" class="content">
		<div class="row">
			<h1 class="page-header">AmasCuotas <small>Formulario Natural</small></h1>
			<br />
